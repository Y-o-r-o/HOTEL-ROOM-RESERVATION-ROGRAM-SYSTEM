    ...
    return (
        ...
        <section>
            {activities && activities.map((activity, i) => (
                <div className={`card ${exist(activity.id) ? `card-active` : ``} flex flex-row`} key={i}>
        ...
        <div className='d-flex justify-content-between mt-3'>
                ...
                }} className='btn btn-primary btn-group-justified'>&lt; Back</button>
                <button onClick={ev => {
                    dispatch({
                        type: 'changeSearch',
                        payload: {
                ...
                }} className='btn btn-primary btn-group-justified'>Continue &gt;</button>
        </div>
        </>
    )
}
